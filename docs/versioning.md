...
Current release: **0.10.0** (`package.json`, tag `v0.10.0`). Newer work after that lives in `CHANGELOG.md` `[Unreleased]`. Version lives in the root `package.json` only. No `VERSION` file. Started at 0.1.0.
