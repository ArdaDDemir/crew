...
Current release: **0.12.9** (`package.json`, tag `v0.12.9`). Newer work after that lives in `CHANGELOG.md` `[Unreleased]`. Version lives in the root `package.json` only. No `VERSION` file. Started at 0.1.0.
