...
- Mentions: no `@` â†’ no turn, except a human post with no mention wakes the channel lead. `@` inside fenced or inline code is not a wake (`ADR-0043`).
...
If AGENTS.md and this file drift, **AGENTS.md wins** â€” then fix this file in the same change.
