...
Irreversible choices go in `docs/adr/` as the next `NNNN-kebab.md` (index: `docs/adr/README.md`, currently **0064**). Accepted ADRs are not rewritten; supersede or qualify them.
