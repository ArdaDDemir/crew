...
v1 is in: mention routing, JSONL, workspace, turn loop, tools, OpenRouter adapter, CLI (`bot`, `channel`, `say`, `dm`, `open`, `mode`). Next features need an ADR if they change the public surface.
